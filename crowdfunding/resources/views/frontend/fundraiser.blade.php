...
<body>
    <div class="container-fluid">
        <div class="left">
            ...
            <h2 style="margin-top:100px; color:#333333">Let's begin your fundraising journey</h2>
            <p  style="margin-top:30px;color:#454444">We are here to guide you every step of the way.</p>
        </div>
        <div class="right">
            @guest
            <div class="nav">
            ...
            @endguest
            <div class="form">
                <form class="form" action="{{ route ('fundraiser.store') }}" method="post"> @csrf
