...
<head>
    ...
    <link rel="stylesheet" href="{{url('frontend/css/others/s_memorial.css')}}">
    ...
    <!-- <div class="container"> -->
        ...
        <div class="section1 col-md-12 d-flex justify-content-evenly">
            <div class="col-md-3" style="width: 40%;">
                <h1 style="font-weight: bold;">Get help with memorial fundraising</h1>
                <p style="opacity: 0.8; font-size:x-large;">With a FundOurCause, you can get immediate help with memorial costs.</p>
                <button type="button" class="btn btn-outline-success" style="width: 250px;">Start a FundOurCause</button>
                <p style="margin-top: 150px; opacity: 0.8;">Donors gave Rs. 1.9 million in memory of murdered MP Jo Cox.</p>
            </div>
            <div class="col-md-3">
                <img src="https://images.unsplash.com/photo-1587721865940-37ebee7fb730?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="Medical Fund Raise" width="160%" height="600">
            </div>
        </div>
        ...
        <div class="section2">
            <div class="d-flex aligns-items-center justify-content-center">
                <h3><strong>We're the leader in online memorial fundraising</strong></h3>
            ...
            <div class="c2 text-center d-flex aligns-items-center justify-content-evenly">
                <div>
                    <h3 style="font-weight: lighter;">125,000+</h3>
                    <p>memorial fundraisers per year</p>
                </div>
                <div>
                    <h3 style="font-weight: lighter;">Rs. 225 million+</h3>
                    <p>raised per year</p>
                </div>
            </div>
        </div>
        ...
        <div class="section3">
            ...
            <div style="margin-top: 20px;">
                <div class="text-center d-flex aligns-items-center justify-content-evenly">
                    <button type="button" class="btn btn-outline-success" style="width: 250px; margin: 10px -100px;">Funeral</button>
                    <button type="button" class="btn btn-outline-success" style="width: 250px; margin: 10px -100px;">Memorial fund</button>
                    <button type="button" class="btn btn-outline-success" style="width: 250px; margin: 10px -100px;">End of life cost</button>
                </div>
                <div class="text-center d-flex aligns-items-center justify-content-evenly">
                    <button type="button" class="btn btn-outline-success" style="width: 250px; margin: 10px -250px">Scholarship fund</button>
                </div>
            </div>
        </div>
        ...
        <div class="section4">
            <div class="c4 col-md-12 d-flex justify-content-evenly">
                <div class="col-md-3" style="width: 40%;">
                    ...
                    <h2 style="font-weight: bold;">Honoring a mother's memory</h2><br>
                    <p style="opacity: 0.8; font-size: large;">After she died aged just 29, Louise's family raised more than Rs. 24,000 for a trust fund for  her chldren.</p>
                </div>
                <div class="col-md-3">
                    <img src="https://images.unsplash.com/photo-1528425646626-fcc5dd57daf5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=358&q=80" alt="Medical Fund Raise">
                </div>
            </div>
