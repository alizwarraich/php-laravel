...
<body>
    <div class="container">
        <div class="nav-wrapper">
            <!-- Left side navs -->
            <div class="left-side">
                <a style="text-decoration:none" href="#">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<div class="container">
    <h1 style="text-align:center; margin-top:-120px; margin-bottom:150px; color:#2A4B80; text-decoration:underline">Admin Dashboard</h1>
    <div class="grids">
        <div class="createfund">
            <a href="{{route('fundraiser')}}">
                <h2 style="color:white" class="gridshead">Create fundraiser</h2>
            </a>
        </div>
        <div class="readfund">
            <a href="{{route('fundraiserRead')}}">
                <h2 style="color:white" class="gridshead head2">View fundraisers</h2>
            </a>
        </div>
    </div>
</div>
